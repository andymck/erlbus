...
t_broadcast(_Config) ->
  ...
  ebus_ps:broadcast(
    ?MODULE, <<"topic1">>,
    erlbus_broadcast:new(<<"topic1">>, <<"fastlaned">>, #{})
  ),

  Fastlaned = erlbus_message:new(<<"topic1">>, <<"fastlaned">>, #{}),
  ...
  Intercepted = erlbus_broadcast:new(<<"topic1">>, <<"intercepted">>, #{}),
  ...
  ebus_ps:broadcast_from(
    ?MODULE, self(), <<"topic1">>,
    erlbus_broadcast:new(<<"topic1">>, <<"other">>, #{})
  ),
